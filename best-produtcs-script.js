class ProductManager {
  ...
  async loadProducts() {
    ...
    console.log(
      `✅ ${this.products.length} ürün başarıyla yüklendi (ham veri).`
    );
  }
  ...
  filterBestSellers() {
    ...
    console.log(
      `⭐ ${this.products.length} ürün "Çok Satanlar" olarak filtrelendi.`
    );
  }
  ...
  createProductCard(product) {
    const { id, image, name, category, price, description, image2, images2 } =
      product;
